  ...
  ((e) => {
    ...
    function w() {
      a.addEventListener("single-file-load-deferred-images-start", () => F()),
        ...
        a.addEventListener("single-file-request-fetch-supported", () =>
          a.dispatchEvent(new d("single-file-response-fetch-supported"))
        ),
    ...
    if ((w(), new y(w).observe(a, { childList: !0 }), e.FontFace)) {
      ...
      (a.fonts.clear = function () {
        return (
          a.dispatchEvent(new d("single-file-clear-fonts")), i.call(a.fonts)
        );
      }),
    ...
    function G() {
      try {
        e.dispatchEvent(new f("resize")), v && e.dispatchEvent(new f("scroll"));
      } catch (e) {}
    }
